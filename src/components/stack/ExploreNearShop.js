...
//           <View style={{ width: 300, height: 120, display: "flex", alignItems: "start", justifyContent: "space-evenly", backgroundColor: "white", margin: 5, padding: 3 }}>
//             <View style={{ paddingLeft: 5 }}>
//               <Text style={{ fontSize: 10 }}>ELECTRONICS & Home Appliance</Text>
//               <Text style={{ fontSize: 20, marginBottom: 5 }}>Bajaj Electronics</Text>
  ...
  const [data, setData] = React.useState(null);
    ...
    useEffect(()=>{
        const fecthdata = async ()=>{
          try{
          const result = await fetch('http://focusmore.codelive.info/api/shop/list',{
           method:'GET',
           headers:{
