...
export default function AddEmployeExpirence() {
  ...
  const [employedropdown, setEmployeDropdownOpen] = useState(false);
    ...
    const handleSumbit = async () => {
      try {
        ...
        const response = await fetch(`https://focusmore.codelive.info/api/add-employee-experience`, {
          method: 'POST',
          headers: {
    ...
    return (
        <>
            <View style={styles.header}>
                <Text style={styles.headerText}>Add Employes Expirence</Text>
            </View>
