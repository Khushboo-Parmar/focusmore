...
//                     <View >
//                         <Text style={{ paddingLeft: 8, fontSize: 20, color: "black" }}>{detailData.data[0]?.name}</Text>
...
//                 <TouchableOpacity onPress={() => { navigation.navigate('Services', { id: detailData.data[0]?.id }) }} style={{ borderBottomWidth: 1, borderBottomColor: "#dddcdc", width: 400, height: 25, display: "flex", alignItems: "center", justifyContent: "space-between", flexDirection: "row" }}>
//                     <View style={{ paddingVertical: 5, display: "flex", alignItems: "center", flexDirection: "row", width: 200, paddingHorizontal: 10 }} >
...
//                 <TouchableOpacity onPress={() => { navigation.navigate('Broucher') }}>
//                     <View style={{ borderBottomWidth: 1, borderBottomColor: "#dddcdc", borderTopWidth: 1, borderTopColor: "#dddcdc", width: 400, display: "flex", alignItems: "center", justifyContent: "space-between", flexDirection: "row" }}>
//                         <View style={{ paddingVertical: 5, display: "flex", alignItems: "center", flexDirection: "row", width: 200, paddingHorizontal: 10 }} >
...
//                 <TouchableOpacity onPress={() => { navigation.navigate('ServiceTiming', { id: detailData.data[0]?.id }) }}>
//                     <View style={{ borderBottomWidth: 1, borderBottomColor: "#dddcdc", borderTopWidth: 1, borderTopColor: "#dddcdc", width: 400, display: "flex", alignItems: "center", justifyContent: "space-between", flexDirection: "row" }}>
//                         <View style={{ paddingVertical: 5, display: "flex", alignItems: "center", flexDirection: "row", width: 200, paddingHorizontal: 10 }} >
...
//                 <View style={{ borderBottomWidth: 1, borderBottomColor: "#dddcdc", width: 400, height: 25, display: "flex", alignItems: "center", justifyContent: "space-between", flexDirection: "row" }}>
//                     <TouchableOpacity onPress={() => { navigation.navigate('Reviews', { screen: 'StackAndBottom', params: { screen: 'Reviews', params: { id: detailData.data[0]?.id } } }) }}>
//                         <View style={{ display: "flex", alignItems: "center", flexDirection: "row", width: 200, paddingHorizontal: 10 }} >
...
const DetailPage = (props) => {
    ...
    const { id } = props.route.params.data[0]; // Accessing the id from route params
